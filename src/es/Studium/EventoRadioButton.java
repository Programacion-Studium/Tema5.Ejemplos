...
public class EventoRadioButton extends Frame implements WindowListener, ItemListener 
{
	private static final long serialVersionUID = 1L;
	// Definir el grupo
	CheckboxGroup grupo = new CheckboxGroup();
	// En este caso, sólo se puede tener activa una de las opciones 
	// Las opciones se crean indicando su etiqueta, si están o no 
	...
	public EventoRadioButton() 
	{
		...
		setTitle("Botones de Opción con sólo uno activo"); 
		add(chkUno);
		add(lblEtiqueta1);
		add(chkDos);
		add(lblEtiqueta2);
