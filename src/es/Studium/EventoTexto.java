...
TextListener
{
	...
	//Creamos el textarea vacío, con 5 filas y 20 columnas 
	TextArea txaCampo2 = new TextArea("",5,20);
	Button btnBoton = new Button ("Añadir texto"); 
	String cadena = "";
	int longitud=0;
	public EventoTexto() 
	{
		...
		//Añadir el listener al textfield para poder escribir en él 
	...
	//Al cambiar el texto en el textfield, guardamos lo escrito en la cadena ca
	...
	public void actionPerformed(ActionEvent ae) 
	{
		...
		//Si no supera los 20, lo metemos en el TextArea a continuación de lo que ya haya 
		if(longitud<=20)
		{
			txaCampo2.setText(txaCampo2.getText()+" "+cadena); 
		}
		//Si no, lo pasamos a la línea siguiente 
		else
		{
